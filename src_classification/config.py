...
parser.add_argument('--model_3d', type=str, default='schnet', choices=['schnet', 'spherenet'])
...
parser.add_argument('--input_model_file1', type=str, default='')
parser.add_argument('--input_model_file2', type=str, default='')
...
parser.add_argument('--saved_complete_file', type=str, default='')
